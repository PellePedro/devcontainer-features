...
# The following functions and checks are from the Homebrew Installer
# (https://github.com/Homebrew/install/blob/master/install.sh)
# licensed under the BSD 2-Clause "Simplified" License
# Out of the different install scripts evaluated as part of our
# investigation (Docker, Ohmyzsh, Homebrew), these functions and checks appear
# to be most useful for Skyramp
...
skyramp_os_arch_download() {
  ...
  then
    ...
    elif [[ "${UNAME_MACHINE}" == "amd64" ]] || [[ "${UNAME_MACHINE}" == "arm64" ]]
    then
